# Converting_text_to_images



## Overview

This model is called StackGAN and this is the code for for reproducing main results in the paper [StackGAN: Text to Photo-realistic Image Synthesis with Stacked Generative Adversarial Networks](https://arxiv.org/pdf/1612.03242v1.pdf).
...
The credits for this code go to [hanzhanggit](https://github.com/hanzhanggit/StackGAN).
